      ...
      h(n, [
        ...
        },
        {
          ...
          value: function(e) {
            ...
            n.y >= o.y - a / 2 && !v
              ? ((s.y = 1), (l.y = u * Math.abs((o.y - a / 2 - n.y) / a)))
              : n.x >= o.x - i / 2 && !x
              ? ((s.x = 1), (l.x = c * Math.abs((o.x - i / 2 - n.x) / i)))
              : n.y <= r.y + a / 2 && !g
              ? ((s.y = -1), (l.y = u * Math.abs((n.y - a / 2 - r.y) / a)))
              : n.x <= r.x + i / 2 &&
                !m &&
                ((s.x = -1), (l.x = c * Math.abs((n.x - i / 2 - r.x) / i))),
          ...
          return (
            ...
            w(p(R), 'handleMove', function(e) {
              ...
              if (
                ...
                var o = G(e),
                  i = {x: R.position.x - o.x, y: R.position.y - o.y},
                      ...
                      var e = function() {
                          var e,
                            ...
                            u =
                              ...
                              (r = window.getComputedStyle(n)).display
                                ...
                                : {x: 0, y: 0}),
                            f = R.container.getBoundingClientRect(),
                          ...
                          if (
                            ...
                            (R.helper = R.helperContainer.appendChild(
                              ...
                              (s = o.cloneNode(!0)),
                              D(s.querySelectorAll(i)).forEach(function(e, t) {
              ...
              if (e) R.autoScroller.clear();
                ...
                if (t) {
                  ...
                  return (
                    ...
                    (R.scrollContainer.scrollLeft += r),
                    void (R.scrollContainer.scrollTop += o)
                  );
                }
            ...
            w(p(R), 'handleKeyDown', function(e) {
              ...
              (R.manager.active && !R.manager.isKeySorting) ||
                !(
                  R.manager.active ||
                  (i.lift.includes(t) && !r(e) && R.isValidSortingTarget(e))
                ) ||
                (e.stopPropagation(),
                e.preventDefault(),
            ...
            w(p(R), 'keyLift', function(e) {
              ...
              (R.initialFocusedNode = t),
                ...
                (R.manager.active = {index: r, collection: o}),
                R.handlePress(e);
            }),
