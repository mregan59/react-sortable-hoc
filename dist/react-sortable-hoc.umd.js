    ...
    return (
      (_temp = _class = (function(_React$Component) {
        ...
        function WithSortableContainer(props) {
          ...
          defineProperty(assertThisInitialized(_this), 'keyLift', function(
            event,
          ) {
          ...
          defineProperty(assertThisInitialized(_this), 'keyMove', function(
            shift,
          ) {
            var nodes = _this.manager.getOrderedRefs();
          ...
          defineProperty(assertThisInitialized(_this), 'keyDrop', function(
            event,
          ) {
          ...
          defineProperty(assertThisInitialized(_this), 'handleKeyEnd', function(
            event,
          ) {
